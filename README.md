...
* Edit the [`configuration/environment.js`](webpack/environment.js) if you want to specify:
...
* `development` - [`configuration/webpack.dev.config.js`](webpack/webpack.dev.config.js)
* `production` - [`configuration/webpack.prod.config.js`](webpack/webpack.prod.config.js)
